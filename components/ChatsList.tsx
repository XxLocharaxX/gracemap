...
export const ChatsList = () => {
  ...
  const { isChatsListOpen, setChatsListOpen, chatsList, loadChatsList, openChat } = useChatStore();
    ...
    <AnimatePresence>
      {isChatsListOpen && (
        <>
          ...
          >
            {/* Хедер панели */}
            <div className="flex items-center justify-between p-4 md:p-6 border-b border-[var(--grace-stone)] bg-white/50 backdrop-blur-md">
